...
const SearchView = React.createClass({
  ...
  onMainButtonClick(){
    if(this.props.searchOpen){
      this.props.dispatch(NavigationState.navigatePush({key:'Progress',title:'Loading...'}))
    }else{
  ...
  render() {
    return (
      <View style={styles.mainContainer} key={'welcome'}>
        ...
        <Image style={styles.image} source={{uri:'https://images.unsplash.com/photo-1444010386442-7946b8c6fc1c?format=auto&auto=compress&dpr=2&crop=entropy&fit=crop&w=1280&h=960&q=80'}} />
         </View>
          {this.renderPopup()}
